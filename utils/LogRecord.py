...
class LogRecord:
    ...
    def log_init(self):
        ...
        if self.align:
            align_str = '_FULL_'  # FULL indicates complete model (non-ablation)
        else:
            align_str = '_noalign_'
        ...
        self.args.out_file.write("=" * 50 + "\n")
        self.args.out_file.write("*** FULL MODEL (Complete architecture, non-ablation) ***\n")
        self.args.out_file.write("=" * 50 + "\n")
